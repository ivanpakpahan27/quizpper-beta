                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div style="margin-bottom:5px">
                                                <button style="width: 80px;" class="btn btn-info m2px" data-toggle="modal" data-target="#info<?= $ls->id_soal; ?>"><i class="fa fa-info"></i> Info</button>
                                            </div>
                                            <div style="margin-bottom:5px">
                                                <a style="width: 80px;" href="<?= base_url('edit_soal/' . $ls->id_soal); ?>" class="btn btn-warning m2px"><i class="fa fa-edit"></i> Edit</a>
                                            </div>
                                            <div>
                                                <button style="width: 80px;" class="btn btn-danger m2px" data-toggle="modal" data-target="#hapus<?= $ls->id_soal; ?>"><i class="fa fa-trash"></i> Hapus</button>
                                            </div>
                                        </td>
                                    </tr>
                                    <!-- Modal Info Soal -->
                            ...
                            foreach ($listsoal as $ls) :
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="<?= base_url('edit_soal/' . $ls->id_soal); ?>" class="btn btn-xs btn-warning m2px"><i class="fa fa-edit"></i> Edit</a>
