    ...
    <section class="content">
        <div class="box box-warning">
            <div class="box-header">
                <button type="button" data-toggle="modal" data-target="#tambah-mapel" class="btn btn-flat btn-success"><i class="fa fa-plus"></i> Tambah Mapel</button>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div style="margin-bottom:5px">
                                        <button style="width: 80px;" class="btn btn-warning" data-toggle="modal" data-target="#editMapel<?= $d->id_mapel; ?>"><i class="fa fa-edit"></i> Edit</button> &nbsp;
                                    </div>
                                    <div>
                                        <button style="width: 80px;" class="btn btn-danger" data-toggle="modal" data-target="#hapusMapel<?= $d->id_mapel; ?>"><i class="fa fa-trash"></i> Hapus</button>
                                    </div>
                                </td>
                            </tr>
                            <!-- Modal Edit Mapel -->
