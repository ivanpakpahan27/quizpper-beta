                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?= $s->nohp; ?></td>
                                <td>
                                    <button class="btn btn-info" data-toggle="modal" data-target="#lihatPassword<?= $s->id_siswa; ?>"><i class="fa fa-eye"></i> Lihat</button>
                                </td>
                                <td>
                                    <div style="margin-bottom: 5px;">
                                        <button style="width: 80px;" type="button" data-toggle="modal" data-target="#editSiswa<?= $s->id_siswa; ?>" class="btn btn-warning" href="#"><i class="fa fa-edit"></i> Edit</button> &nbsp;
                                    </div>
                                    <div>
                                        <button style="width: 80px;" type="button" data-toggle="modal" data-target="#hapusSiswa<?= $s->id_siswa; ?>" class="btn btn-danger" href="#"><i class="fa fa-user-times"></i> Hapus</button>
                                    </div>
                                </td>
                            </tr>
