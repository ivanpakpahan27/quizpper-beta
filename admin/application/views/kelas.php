                            ...
                            <tr>
                                ...
                                <td>
                                    <div style="margin-bottom: 5px;">
                                        <button style="width: 80px;" class="btn btn-warning" data-toggle="modal" data-target="#editKelas<?= $k->id_kelas; ?>"><i class="fa fa-edit"></i> Edit</button> &nbsp;
                                    </div>
                                    <div>
                                        <button style="width: 80px;" class="btn btn-danger" data-toggle="modal" data-target="#hapusKelas<?= $k->id_kelas; ?>"><i class="fa fa-trash"></i> Hapus</button>
                                    </div>
                                </td>
                            </tr>
                            <!-- Modal Edit Kelas -->
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <div style="margin-bottom: 5px;">
                                        <button style="width: 80px;" class="btn btn-warning" data-toggle="modal" data-target="#editJurusan<?= $j->id_jurusan; ?>"><i class="fa fa-edit"></i> Edit</button> &nbsp;
                                    </div>
                                    <div>
                                        <button style="width: 80px;" class="btn btn-danger" data-toggle="modal" data-target="#hapusJurusan<?= $j->id_jurusan; ?>"><i class="fa fa-trash"></i> Hapus</button>
                                    </div>
                                </td>
                            </tr>
                            <!-- Modal Edit Jurusan -->
