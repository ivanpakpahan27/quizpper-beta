        ...
        <section class="content">
            <div class="box box-warning">
                <div class="box-header">
                    <button type="button" data-toggle="modal" data-target="#tambah-guru" class="btn btn-flat btn-success"><i class="fa fa-user-plus"></i> Tambah Guru</button>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?= $g->nama; ?></td>
                                    <td><?= $g->mapel; ?></td>
                                    <td><button class="btn btn-success" data-toggle="modal" data-target="#lihatLogin<?= $g->id_guru; ?>"><i class="fa fa-eye"></i> Lihat</button></td>
                                    <td>
                                        <div>
                                            <button style="width: 80px;" type="button" data-toggle="modal" data-target="#editGuru<?= $g->id_guru; ?>" class="btn btn-warning"><i class="fa fa-edit"></i> Edit</button>
                                        </div>
                                        <div class="" style="margin-top: 5px;">
                                            <button style="width: 80px;" type="button" data-toggle="modal" data-target="#hapusGuru<?= $g->id_guru; ?>" class="btn btn-danger"><i class="fa fa-user-times"></i> Hapus</button>
                                        </div>
                                    </td>
                                </tr>
