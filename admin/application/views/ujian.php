                            ...
                            <tr>
                                ...
                                <td>
                                    <div style="margin-bottom: 5px;">
                                        <button style="width: 80px;" class="btn btn-warning" data-toggle="modal" data-target="#edit<?= $lu->id_ujian; ?>"><i class="fa fa-edit"></i> Edit</button> &nbsp;
                                    </div>
                                    <div>
                                        <button style="width: 80px;" class="btn btn-danger" data-toggle="modal" data-target="#hapusujian<?= $lu->id_ujian; ?>"><i class="fa fa-trash"></i> Hapus</button>
                                    </div>
                                </td>
                            </tr>
